...
Humedad relativa: 
  ...
  Existen estudios que han reportado una relación inversa entre la humedad relativa y la concentración de PM~2.5~, como la encontrada en nuestro trabajo [@nogarotto2020review ;@liu2020varying; @he2019exploring; @chen2016spatial].
...
Velocidad del viento: 
  A pesar de la tendencia inversa que puede observarse en esta escala temporal, no se observa una marcada relación entre las variables. Por este motivo, será necesario realizar un análisis más detallado para determinar la existencia y la naturaleza de esta relación en escalas de tiempo más finas.
