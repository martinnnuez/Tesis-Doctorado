...
| Modelo  | Set de datos | *RMSE* | 
|------------------------------|:--------------:|:-------:|
| Redes neuronales recurrentes | Original | 3.441 |
| Redes neuronales recurrentes | Reducido | 3.533 |
| K vecinos más cercanos | Original | 3.552 |
| K vecinos más cercanos | Reducido | 3.602 | 
| Bosques Aleatorios | Original | 4.101 |
| Bosques Aleatorios | Reducido | 4.317 |
| Regresión de Soporte Vectorial | Reducido | 5.692 | 
| Regresión de Soporte Vectorial | Original | 5.772 |
| GBM ligero | Original | 7.123 |
| GBM ligero | Reducido | 7.283 | 
| Regresión lineal | Original | 8.029 |
| Regresión Ridge | Original | 8.029 | 
| Regresión SGD | Original | 8.03 |
| Regresión SGD | Reducido | 8.26 | 
| Regresión lineal | Reducido | 8.304 | 
| Regresión Ridge | Reducido | 8.304 |
| Regresión Lasso | Original | 9.011 |
| Regresión Lasso | Reducido | 9.023 | 
| Regresión de red elástica | Original | 9.853 | 
| Regresión de red elástica | Reducido | 9.853 |
|  |  |  |  |  |
| *Modelo de referencia* | Base | 3.676 | 
