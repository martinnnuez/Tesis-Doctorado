...
| *Modelo de referencia* | 2.775 | 2.775 |
  ...
  El modelo óptimo en términos de su capacidad predictiva de bosques aleatorios se encontró compuesto por total de 200 árboles individuales en el bosque, además para lograr la separación en un nuevo nodo fue necesario contar con más de dos muestras en cada uno de ellos. Las predicciones del algoritmo que demostró mayor capacidad predictiva difieren en promedio de los valores reales medidos de concentración de PM~2.5~ en 2.324 $\frac{\mu g}{m^3}$.
