...
Table: Error cuadrático medio de predicción (*RMSE*) de modelos ajustados para predecir la concentración de PM~2.5~ en el uso de suelo industrial a partir de 193 variables satelitales (base de datos original) y 84 variables seleccionadas (base de datos reducida). \label{tab:modaa} 
