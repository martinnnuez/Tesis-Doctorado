...
## Conclusión
  ...
  Los resultados del estudio indican que las variables satelitales y meteorológicas tiene potencialidad para explicar la variabilidad espacio temporal de la concentración de PM~2.5~.  
  
  La inclusión de variables meteorológicas y satelitales como variables independientes en la base de datos para desarrollar el modelo predictivo para la concentración de PM~2.5~ permitirá obtener resultados de elevada exactitud. 