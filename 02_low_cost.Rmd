...
### Consenso en las mediciones de los sensores de bajo costo
...
## Conclusión
  ...
  Se puede concluir que los sensores de bajo costo presentaron una alta consistencia en sus mediciones, con registros similares independientemente del sensor utilizado. Esta consistencia entre los datos es un indicador de la fiabilidad de los sensores y sugiere que estos dispositivos pueden ser utilizados para monitorear la concentración de PM~2.5~ en el aire.
  
  Además, se puede afirmar que los datos registrados por los sensores de bajo costo son también consistentes con los datos de una estación de referencia, indicando que estos dispositivos proporcionan mediciones representativas de la concentración de material particulado. Por lo tanto, son una alternativa viable y económica para la medición de la calidad del aire en áreas urbanas y rurales.