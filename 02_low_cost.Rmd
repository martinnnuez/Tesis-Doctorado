...
(ref:sens) Resumen gráfico del protocolo analítico desarrollado en el capítulo 2.
  ...
  La figura \@ref(fig:sens) presenta el protocolo analítico desarrollado en este capítulo con la finalidad de desarrollar y validar sensores de monitoreo basados en tecnologías de bajo costo que posibiliten recopilar datos de concentración horaria de PM~2.5~ a lo largo del tiempo. En primer lugar, se realizó una investigación de las tecnologías de bajo costo disponibles en el mercado referidas a medición de la concentración de PM. Posteriormente a la adquisición de los respectivos recursos materiales, se desarrolló el código que daría sustento a la interacción de los distintos sensores de bajo costo que formaron el sistema, para su seguido ensamblado. Una vez que los diez sistemas de monitoreo se encontraron en funcionamiento, se evaluó la calidad del dato recopilado, lo cual se abordó en dos etapas: la primera se centró en determinar el consenso de las mediciones obtenidas por los distintos sensores, mientras que la segunda se enfocó en comparar las mediciones con respecto a las de una estación de referencia, evaluando su fiabilidad y precisión en relación con una fuente de datos establecida y confiable.
...
## Conclusión
  ...
  Los sistemas de monitoreo basados en sensores de bajo costo desempeñan un papel fundamental al recopilar datos áreas donde la gestión y el control de la calidad del aire son inexistentes. Estos sistemas son el paso inicial al desarrollo de sistemas de alerta ante condiciones adversas de calidad del aire, paleando la inaccesibilidad a datos de contaminación de aire y fortaleciendo los pilares sobre los cuales recae la salud publica.