...
(ref:mod) Resumen gráfico del protocolo analítico desarrollado en el capítulo 5.
  ...
  La figura \@ref(fig:mod) ilustra el protocolo analítico desarrollado en el capítulo 5, proporcionando una visión ordenada y resumida de los procedimientos desarrollados para lograr su objetivo. Principalmente se hace referencia al procedimiento de ajuste y selección del mejor modelo de predicción que puede desarrollarse, implementando como datos de entrada variables meteorológicas, ambientales y temporales, obtenidas principalmente de satélites, para predecir la concentración de PM~2.5~ con un horizonte de predicción de cinco días de anticipación. Es importante destacar la variada naturaleza de los datos de entrada, entre los cuales se destacan variables relacionadas al uso del suelo y otras que describen el estado de la superficie terrestre, además de variable climáticas que describen el estado de la atmósfera en un momento determinado y variables temporales que se vinculan a las fluctuaciones y ciclos descriptos por la variable dependiente.  
