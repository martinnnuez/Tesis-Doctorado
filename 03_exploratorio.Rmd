...
\begin{flushleft}
\setstretch{0.5}
{\footnotesize Uso de suelo, cantidad de veces que supera los límites propuestos por la Organización Mundial de la Salud (OMS) / porcentaje de tiempo en que se vio superada dicha normativa y cantidad de veces que supera la resolución 105/17 de la Provincia de Córdoba (CBA) / porcentaje de tiempo en que se vio superada dicha normativa.}
\end{flushleft}
