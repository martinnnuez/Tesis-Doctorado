...
## Conclusión
  ...
  Los usos de suelo derivados a partir de la serie temporal de concentración de PM~2.5~ representan el patrón de emisión característico de cada uno de los sitios de muestreo, existiendo coincidencia entre la cantidad de veces que se superan las normativas propuestas (Tabla \@ref(tab:guiapm)) y las características de los sitios que agrupa cada uno de los aglomerados (Tabla \@ref(tab:concsup)). Puede apreciarse que en los sitios cuyo uso de suelo es industrial, la cantidad de veces en que se superan los estándares es mayor a las que sucede en el uso de suelo urbano y agrícola/área verde, siendo este último en el que se registró la menor cantidad de estos eventos. 
  
  Se ha demostrado que los patrones espaciales y temporales descriptos poseen potencial para explicar la variabilidad de la concentración de PM~2.5~, además las variación de las condiciones meteorológicas a lo largo de las distintas escalas temporales demostró potencialidad para explicar la variación de la concentración de PM~2.5~ independientemente del uso de suelo que se este considerando.