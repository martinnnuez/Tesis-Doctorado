...
Tabla \@ref(tab:hypurb): Hiperparámetros optimizados para los algoritmos en el uso del suelo urbano sobre la base de datos reducida.
...
Tabla \@ref(tab:hypind): Hiperparámetros optimizados para los algoritmos en el uso del suelo industrial sobre la base de datos reducida.
...
Tabla \@ref(tab:hypaa): Hiperparámetros optimizados para los algoritmos en el uso del suelo agrícola y áreas verdes sobre la base de datos reducida..
Referencia: Modelo, biblioteca/paquete/fuente del algoritmo, nombre del hiperparámetro y valor del hiperparámetro. \label(#tab:hypaa)
