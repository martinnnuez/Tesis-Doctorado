# Anexo 1: Bases de datos satelitales {-}
...
Table: Resumen de los desfasajes temporales con capacidad predictiva para cada una de las variables satelitales analizadas.\label{tab:resumen}
...
# Anexo 3: Descripción de variables meteorológicos y satelitales {-}
...
Table: Hiperparámetros optimizados para los algoritmos en el uso del suelo urbano sobre la base de datos reducida.
Referencia: Modelo, biblioteca-paquete-fuente del algoritmo, nombre del hiperparámetro y valor del hiperparámetro.\label{tab:hypurb}
...
Table: Hiperparámetros optimizados para los algoritmos en el uso del suelo industrial sobre la base de datos reducida.
Referencia: Modelo, biblioteca-paquete-fuente del algoritmo, nombre del hiperparámetro y valor del hiperparámetro. \label{tab:hypind}
...
Table: Hiperparámetros optimizados para los algoritmos en el uso del suelo agrícola y áreas verdes sobre la base de datos reducida.
Referencia: Modelo, biblioteca-paquete-fuente del algoritmo, nombre del hiperparámetro y valor del hiperparámetro.\label{tab:hypaa}
